...
const SessionUser = ({
  ...
  return (
    <SessionInfo>
      <PlateAndAddPlateBtnWrapper center={sessionStatus !== null}>
        {!toggleAddPlate ? (
          <PlateSelectInput
            MenuProps={MenuProps}
            name='plate'
            ...
            renderValue={(v) => v}
            inputProps={{
              readOnly: sessionStatus === null ? false : true,
            }}
                ...
                <PlateDropdownItem key={ind} value={p}>
                  ...
                  isLoadingDeletePlate.itemInd === ind ? (
                    ...
                    <IconButton
                      ...
                      onClick={(e) => handleDeletePlate(e, p, ind)}
                    >
                      <RemoveIcon />
                    </IconButton>
                  )}
          ...
          <Input
            autoFocus
            disabled={sessionStatus === null ? false : true}
            name='newPlate'
            style={{
              width: '49%',
              textAlign: 'center',
