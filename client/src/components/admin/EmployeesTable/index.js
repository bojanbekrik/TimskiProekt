          ...
          <TableBody>
            {filteredEmployees.map((employeeData) => (
              <TableRow
                ...
                onClick={() => onRowClick(employeeData.workerId)}
              >
                ...
                >
                  <DropdownViewer
                    data={employeeData.parkingZones.map((z) => z.pzName)} // TODO DELETE - after backend fix
                    width='200px'
                  />
                </TableCell>
                <TableCell align='center'>{employeeData.mobile}</TableCell>
                <TableCell align='center'>
                ...
                <ButtonTableCell align='center'>
                  <ToggleAccoutStatusButton
                    onClick={(event) =>
                      onAccountStatusClick(event, employeeData.workerId)
                    }
